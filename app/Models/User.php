 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\User whereActivationKey($value)
...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'user_name', 'email', 'password', 'activation_key', 'is_active'
    ];
